...
{
    const s = "SETTING";    //Target Server   [!!!   SETTING   !!!]   **Which server are we hacking??? (case sensitive)**
    ...
    const ib = mb * SETTING;   //Ideal Server Balance   [!!!   SETTING   !!!]   **How full should the balance remain??? (0-1)**
    const is = ms + SETTING;  //Ideal Server Security   [!!!   SETTING   !!!]   **How many levels above minimum security before**
